...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.0.823
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/dnspod v1.0.823
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/privatedns v1.0.823
